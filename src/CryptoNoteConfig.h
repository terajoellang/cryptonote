...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x1f34ff;
...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(10062013000000);
...
const char     CRYPTONOTE_NAME[]                             = "SiteraCoin";
